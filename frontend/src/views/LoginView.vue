  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleLogin">
        ...
        <div>
          <button type="submit" class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md  bg-brand-orange hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-orange hover:cursor-pointer transition hover:duration-150 bg-gray-700 text-white">
            Iniciar sesión
          </button>
        </div>
